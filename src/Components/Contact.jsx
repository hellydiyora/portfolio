...
const Contact = () => {
  ...
  return (
    <div className="bg-[#E1D7B7] dark:bg-slate-900 pt-20 h-lvh relative flex justify-center items-center font-askilon">
      {alertMessage && (
      ...
      <div className="w-1/2 px-10 ">
        ...
        <p className="text-2xl font-semibold text-[#133122] dark:text-[#C1BAA1] py-5">
          <span className="font-light">
            Get in touch with me via social media or send me an email.
          </span>
          <div className="grid grid-cols-2 gap-2 pt-4 px-10">
            {" "}
            <a
      ...
      <div className="w-3/4 font-poppins text-lg">
        <form
          ref={form}
          onSubmit={sendEmail}
          className="bg-white dark:bg-[#2d3e5e] p-6 m-6 shadow-neutral-500 dark:shadow-neutral-700 shadow-lg rounded-lg space-y-4  place-items-center"
        >
          <h1 className="text-5xl  text-[#4B5945] dark:text-white font-bold text-center p-4">
            Send me an email
          </h1>
